...
static FloatImage *intensity = NULL;     /* variable drawing intensity */
static float draw_intensity = 1.0;       /* drawing intensity */
...
/******************************************************************************
Set streamline drawing intensity.  Constant value.
******************************************************************************/

void vis_set_intensity(float c)
{
  if (intensity) {
    delete intensity;
    intensity = NULL;
...
/******************************************************************************
Set the intensity with which a streamline should be drawn.  Variable
according to an image.
******************************************************************************/

void vis_set_intensity(FloatImage *img, float min, float max)
{
  if (intensity)
    delete intensity;
...
/******************************************************************************
Given a position, return the drawing intensity.
******************************************************************************/
...
/******************************************************************************
Return 1 if the intensity is variable, otherwise return 0.
******************************************************************************/

int vis_intensity_varies()
{
  if (intensity)
    return 1;
  else
